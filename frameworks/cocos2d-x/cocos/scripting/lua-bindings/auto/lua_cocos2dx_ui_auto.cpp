...
int lua_cocos2dx_ui_Button_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.Button:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_CheckBox_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.CheckBox:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_ImageView_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.ImageView:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_Text_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.Text:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_TextAtlas_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.TextAtlas:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_LoadingBar_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.LoadingBar:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_ListView_getItemModel(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::ListView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_ListView_getItemModel'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
            return 0;
        cocos2d::ui::Widget* ret = cobj->getItemModel();
        object_to_luaval<cocos2d::ui::Widget>(tolua_S, "ccui.Widget",(cocos2d::ui::Widget*)ret);
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ccui.ListView:getItemModel",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_ListView_getItemModel'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_ListView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ListView");
        ...
        tolua_function(tolua_S,"getItemModel",lua_cocos2dx_ui_ListView_getItemModel);
...
int lua_cocos2dx_ui_TextField_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.TextField:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_TextBMFont_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.TextBMFont:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_HBox_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.HBox:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_VBox_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.VBox:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_RelativeBox_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.RelativeBox:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_Scale9Sprite_create(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.Scale9Sprite:create",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_Scale9Sprite_createWithSpriteFrameName(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.Scale9Sprite:createWithSpriteFrameName",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_cocos2dx_ui_Scale9Sprite_createWithSpriteFrame(lua_State* tolua_S)
{
    ...
    ok  = true;
    CCLOG("%s has wrong number of arguments: %d, was expecting %d", "ccui.Scale9Sprite:createWithSpriteFrame",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
